...
{
	public class ThimbletackProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			...
			ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, Main.projFrames[Projectile.type], 6)
				.WithOffset(+0, -10f)
				.WithSpriteDirection(-2)
				.WithCode(DelegateMethods.CharacterPreview.Float);
		}
		public override void SetDefaults(){
			Projectile.CloneDefaults(ProjectileID.PetLizard); // Copy the stats of the Spiffo
			AIType = ProjectileID.PetLizard; // Mimic the Spiffo during AI.
			}
